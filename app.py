...
# --- වෙන වෙනම බටන් දෙකක් මඟින් සර්වර් ප්‍රශ්න මඟහරවා ගැනීම ---
st.markdown("### 1. Generate Voice Audio (පළමුව ශබ්දය සාදාගන්න)")
...
st.markdown("---")
st.markdown("### 2. Generate Video (දෙවනුව වීඩියෝව සාදාගන්න)")
